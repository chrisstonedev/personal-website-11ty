...
export default function (eleventyConfig) {
	...
	eleventyConfig.addPassthroughCopy({
		...
		'node_modules/reveal.js/dist/theme/fonts/source-sans-pro/source-sans-pro.css':
			'reveal/fonts/source-sans-pro/source-sans-pro.css',
		'node_modules/reveal.js/dist/theme/fonts/source-sans-pro/source-sans-pro-italic.ttf':
			'reveal/fonts/source-sans-pro/source-sans-pro-italic.ttf',
		'node_modules/reveal.js/dist/theme/fonts/source-sans-pro/source-sans-pro-italic.woff':
			'reveal/fonts/source-sans-pro/source-sans-pro-italic.woff',
		'node_modules/reveal.js/dist/theme/fonts/source-sans-pro/source-sans-pro-regular.ttf':
			'reveal/fonts/source-sans-pro/source-sans-pro-regular.ttf',
		'node_modules/reveal.js/dist/theme/fonts/source-sans-pro/source-sans-pro-regular.woff':
			'reveal/fonts/source-sans-pro/source-sans-pro-regular.woff',
		'node_modules/reveal.js/dist/theme/fonts/source-sans-pro/source-sans-pro-semibold.ttf':
			'reveal/fonts/source-sans-pro/source-sans-pro-semibold.ttf',
		'node_modules/reveal.js/dist/theme/fonts/source-sans-pro/source-sans-pro-semibold.woff':
			'reveal/fonts/source-sans-pro/source-sans-pro-semibold.woff',
	...
	eleventyConfig.addAsyncShortcode(
		...
		async (title, slug, description, pageUrl, pageTag) => {
			let openGraphImageOutputDirectory = `img/preview`;
			let filename = slug || 'index';

			function createTextSvgFromString(
				textContent,
				maxCharsPerRow,
				topY,
				lineHeight,
				...
				return textRows.reduce((textSvg, row, i) => {
					return (
						textSvg +
						`<text font-family="Verdana" x="50" y="${topY + i * lineHeight}" fill="#003" font-size="${fontSizeInPt}pt" font-weight="${fontWeight}">${row}</text>`
					);
				}, '');
			}
	...
	<g>
		...
		${urlText}
			...
			const profileImage = await sharp(
				`./${inputDirectory}/img/chris-stone-square.png`,
			)
			...
			await sharp(Buffer.from(svg))
				...
				.png()
				.toFile(
					`./${outputDirectory}/${openGraphImageOutputDirectory}/${filename}.png`,
				);
